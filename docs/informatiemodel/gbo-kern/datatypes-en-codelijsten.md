...
| `BAGID` | `Identificatie` | BAG-objectidentificatie: een 16-cijferige code, opgebouwd uit gemeentecode (4), objecttypecode (2) en objectvolgnummer (10). | [BAG-objecten (Kadaster)](https://www.kadaster.nl/-/bag-objecten) | Gebruikt voor de BAG-objecten Pand, Verblijfsobject, Standplaats, Ligplaats, Nummeraanduiding, Openbare ruimte en Woonplaats, en voor verwijzingen daarnaar (zoals `adresseerbaarObjectId`). |
