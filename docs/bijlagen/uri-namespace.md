...
|--------|-----------|-------------|
| `gbo:` | `https://lod.gbo-semantiek.nl/def/` | Ontologie-definities (klassen, eigenschappen) |
| `gbobegrip:` | `https://lod.gbo-semantiek.nl/begrip/` | Begrippenkader (SKOS concepten) |
